...
Tabs follow the pattern `{RunnerName}_{StartDate/EndDate}` (e.g. `Nishant_May5/15` or `Nishant_Apr28/May4`). The app resolves the correct tab dynamically — never by constructing the name.
